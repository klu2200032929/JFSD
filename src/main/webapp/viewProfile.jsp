    ...
    <div class="profile-container">
        <div class="profile-header">
            ...
            <div class="profile-details">
                ...
                <p><strong>ID:</strong><%=farmer.getId() %></p>
                <p><strong>Email:</strong><%=farmer.getEmail() %></p>
                <p><strong>Phone:</strong> <%=farmer.getContactno() %></p>
                <p><strong>Address:</strong> <%=farmer.getLocation() %></p>
            </div>
        </div>
